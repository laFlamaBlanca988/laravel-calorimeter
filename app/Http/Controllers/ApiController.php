...
class ApiController extends Controller
{
    ...
    public function editMeal(Request $request, $id): JsonResponse
    {
        ...
        if ($validator->fails()) {
            ...
            if ($mealID == $id && $userID == auth()->id() && ($editRowID || $editRowID == 0)) {
                return response()->json(['status' => 200, 'message' => 'Meal edited successfully!']);
            } else {
                return response()->json(['status' => 401, 'message' => 'Wrong credentials!']);
            }
        }
    ...
    public function deleteMeal(Request $request, $id): JsonResponse
    {
        $meals = new Meal;
