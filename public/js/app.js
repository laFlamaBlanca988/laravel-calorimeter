...
var userMealsTable = document.querySelector('.user-meals-table-container');
var editUserButtons = document.getElementsByClassName('edit-user-open-btn');
var adminMealsTable = document.querySelector('.admin-meals-table');
...
var displayUsers = function displayUsers() {
  ...
  mealsTable.style.display = 'none'; // userMealsTable.style.display = 'none';
};

var displayMeals = function displayMeals() {
  mealsTable.style.display = 'block';
  usersTable.style.display = 'none'; // userMealsTable.style.display = 'none';
};
